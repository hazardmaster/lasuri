...
<div class="container">
	...
	<div class="col-sm-12">
		...
		<?php
			...
			echo "<h5 class='text-danger '>Home >> ".$y['cat_name']." >> ".$y['subcat_name']."</h5>";
...
<table class="table table-responsive table-bordered table-striped table-hover text-center">
		...
		<?php
			...
			echo "<caption class='text-center text-danger'><h3>".$y['subcat_name']."</h3></caption>";
...

			{
				...
				<tr>
					...
					<th class="text-center"><?php echo $y['field1'] ?></th>
