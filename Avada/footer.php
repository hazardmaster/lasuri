	...
	<footer id="footer">
		<div class="avada-row">
			<div class="copyright-area-content">
				<div class="copyright">
					<div><?php
echo "© 2019 Lasuri Insurance Agency | All Rights Reserved.  <a href=\"http://www.lasuri-insurance.com\">  </a>\n";

echo "| Designed By : <a href=\"http://www.planetmediasystems.com\">Planet Media Systems.  </a>\n";
?></div>
				</div>
